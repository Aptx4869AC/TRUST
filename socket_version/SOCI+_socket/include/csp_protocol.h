 ...
 * @param cp_sock
 */
void CSP_TEE_SCMP_version1(PaillierThdDec &csp, int &cp_sock)
{
    mpz_t d, D, D1, epi, e_one_sub_pi, D2, u0, one_sub_u0;
    mpz_inits(d, D, D1, epi, e_one_sub_pi, D2, u0, one_sub_u0, NULL);
    recv_mpz(cp_sock, D1);
    recv_mpz(cp_sock, D);
    recv_mpz(cp_sock, epi);
    recv_mpz(cp_sock, e_one_sub_pi);
    ...
    mpz_clears(d, D, D1, epi, e_one_sub_pi, D2, u0, one_sub_u0, res, e1, e2, NULL);
