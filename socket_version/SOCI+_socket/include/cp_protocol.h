...
void CP_SMUL(mpz_t res, mpz_t ex, mpz_t ey, PaillierThdDec cp, bool record_bytes_flag)
{
    ...
    if (record_bytes_flag)
    {
        ...
        dec_vec.push_back(e_xr1_mul_yr2);
...
void SSBA(mpz_t s_x, mpz_t u_x, mpz_t ex, PaillierThdDec cp, bool record_bytes_flag)
{
    ...
    // Step-1
    CP_SCMP(s_x, ex, e0, cp, record_bytes_flag);
 ...
 * @param record_bytes_flag
 */
void SDIV(mpz_t eq, mpz_t ee, mpz_t ex, mpz_t ey, int ell, PaillierThdDec cp, bool record_bytes_flag)
{
    Offline_val tuple_S0 = cp.pai.offlineVal;
    ...
    for (int i = ell; i >= 0; i--)
    {
        ...
        // Step-3
        CP_SCMP(u, ee, c, cp, record_bytes_flag);
 ...
 * @param record_bytes_flag
 */
void CP_TEE_SMUL(mpz_t res, mpz_t ex, mpz_t ey, PaillierThdDec cp, bool record_bytes_flag)
{
 ...
 * @param record_bytes_flag
 */
void CP_TEE_SCMP_version1(mpz_t res, mpz_t ex, mpz_t ey, PaillierThdDec cp, bool record_bytes_flag)
{
    Offline_val tuple_S0 = cp.pai.offlineVal;
    ...
    if (pi == 0)
    {
        ...
        mpz_set(e_one_sub_pi, tuple_S0.e1);
    ...
    send_mpz(csp_sock, e_one_sub_pi);
    if (record_bytes_flag)
    {
        vector <mpz_ptr> src_vec;
        src_vec.push_back(D1);
        ...
        src_vec.push_back(e_one_sub_pi);
        total_bytes += save_to_file("CP_output.txt", src_vec);
    }
    ...
    mpz_clears(er4, er3r4, D, D1, exr1, neg_eyr1, neg_r1, eyr1, neg_exr1, epi, e_one_sub_pi, NULL);
 ...
 * @param record_bytes_flag
 */
void CP_TEE_SCMP_version2(mpz_t res, mpz_t ex, mpz_t ey, PaillierThdDec cp, bool record_bytes_flag)
{
    Offline_val tuple_S0 = cp.pai.offlineVal;
 ...
 * @param record_bytes_flag
 */
void CP_TEE_SABS(mpz_t res, mpz_t ex, mpz_t ey, PaillierThdDec cp, bool record_bytes_flag)
{
    Offline_val tuple_S0 = cp.pai.offlineVal;
    ...
    send_mpz(csp_sock, D1);
    send_mpz(csp_sock, D);
    send_mpz(csp_sock, e_x_sub_y);
    if (record_bytes_flag)
    {
        vector <mpz_ptr> src_vec;
        src_vec.push_back(D1);
        src_vec.push_back(D);
        src_vec.push_back(e_x_sub_y);
        total_bytes += save_to_file("CP_output.txt", src_vec);
    }
    ...
    mpz_clears(er4, er3r4, D, D1, exr1, neg_eyr1, neg_r1, eyr1, neg_exr1, one_sub_twopi, NULL);
 ...
 * @param record_bytes_flag
 */
void TEE_SDIV(mpz_t eq, mpz_t ee, mpz_t ex, mpz_t ey, int ell, PaillierThdDec cp, bool record_bytes_flag)
{
    Offline_val tuple_S0 = cp.pai.offlineVal;
    ...
    for (int i = ell; i >= 0; i--)
    {
        ...
        // Step-3
        CP_TEE_SCMP_version1(u, ee, c, cp, record_bytes_flag);
        ...
        // Step-5
        CP_TEE_SMUL(m, u, c, cp, record_bytes_flag);
