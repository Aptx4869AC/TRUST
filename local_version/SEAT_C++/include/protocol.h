...
//         printf("-------------------------------\n");
    ...
    void check_feql(int i, mpz_t res, mpz_t m_1, mpz_t m_2, Paillier pai)
    {
        mpz_t z, answer;
        mpz_inits(z, answer, NULL);
    ...
    void check_fabs(int i, mpz_t res, mpz_t m_1, Paillier pai)
    {
        mpz_t z, answer;
        mpz_inits(z, answer, NULL);
    ...
    void check_ftrn(int i, mpz_t res, mpz_t m_1, mpz_t m_2, mpz_t m_3, Paillier pai)
    {
        mpz_t z, answer;
        mpz_inits(z, answer, NULL);
